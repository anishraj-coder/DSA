...
public class BinaryTreePostorderTraversal {
    ...
    public List<Integer> postorderTraversal(TreeNode root) {
        ...
        TreeNode node=root;
        while(!st1.isEmpty()){
            TreeNode popped=st1.pop();
            st2.push(popped);
            if(popped.left!=null)st1.push(popped.left);
            if(popped.right!=null)st1.push(popped.right);
        }
    ...
    public static void main(String[] args) {
        BinaryTreePostorderTraversal processor = new BinaryTreePostorderTraversal();
