...
public class MorrisPreorderTraversal {
    ...
    // Goal: Retrieve the preorder traversal using strictly O(1) extra space.
    // Ensure all temporary tree handles and threads are cleaned up before returning!
    ...
    public static void main(String[] args) {
        MorrisPreorderTraversal runner = new MorrisPreorderTraversal();
        int passed = 0;
        int totalTests = 10;
        ...
        // Test Case 4: Strictly Left-Skewed Tree (Tests immediate printing before moving left)
        TreeNode tc4 = buildTree(new Integer[]{4, 3, null, 2, null, 1});
        List<Integer> exp4 = Arrays.asList(4, 3, 2, 1);
        ...
        List<Integer> exp6 = Arrays.asList(4, 2, 1, 3, 6, 5, 7);
        ...
        List<Integer> exp7 = Arrays.asList(0, -5, -10, 5, 2, 5);
        ...
        List<Integer> exp8 = Arrays.asList(1, 2, 3, 4);
        ...
        List<Integer> exp9 = Arrays.asList(1, 10, 5, 2, 1);
        ...
        List<Integer> exp10 = Arrays.asList(8, 4, 2, 1, 3, 6, 5, 7, 12, 10, 9, 11, 14, 13, 15);
    ...
    private static int runTest(int id, TreeNode root, List<Integer> expected, MorrisPreorderTraversal runner) {
        ...
        System.out.println("Expected Preorder Sort  : " + expected);

        List<Integer> actual = runner.preorderTraversal(root);
